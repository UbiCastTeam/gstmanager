...
Based on the gstreamer-0.10 python bindings, gstmanager is a python module containing a basic gstreamer programming context to ease application development, with an emphasis on string-based manipulations; it currently offers the following features:
